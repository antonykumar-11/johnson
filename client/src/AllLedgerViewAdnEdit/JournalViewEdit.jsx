...
const JournalVoucher = () => {
  ...
  } = useGetJournalVoucherByIdQuery(transactionId || "", {
    skip: !transactionId,
  });
  const [updateJournalVoucher] = useUpdateJournalVoucherMutation();
      ...
      <main className="flex-grow flex justify-center items-center p-4">
        <div className={containerClass}>
          <h2 className="text-3xl font-bold mb-6 text-center">
            {transactionId ? "Edit Journal Voucher" : "Create Journal Voucher"}
          </h2>
