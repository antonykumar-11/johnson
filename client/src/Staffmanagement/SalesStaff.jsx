...
const EmployeeDetail = () => {
  ...
  useEffect(() => {
    if (employee) {
      ...
      // Set common form data for both "employee" and "Owner"
      const commonData = {
      ...
      // Check if the employee is of type "employee" and conditionally add specific fields
      if (employee.registrationType === "employee") {
        setFormData({
          ...commonData,
          vehicleRegistrationNumber: employee.vehicleRegistrationNumber,
          ownerName: employee.userName, // Only for employee registration type
          vehicleType: employee.vehicleType,
          rentalStartDate: employee.rentalStartDate,
          gst: employee.gst,
        });
      } else {
        setFormData(commonData); // For owner registration type, no additional fields
      }
    }
  }, [employee]);
