...
const PayMasterPriview = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg dark:bg-gray-800 dark:border-gray-600 transition duration-300">
      ...
      <div className="block md:hidden grid grid-cols-1 gap-4">
        ...
        {Object.keys(monthSummary).length > 0 ? (
          Object.keys(monthSummary).map((month) => (
            ...
            >
              <h3 className="text-lg font-semibold dark:bg-gray-700 text-gray-700 dark:text-gray-300">
                {month}
              </h3>
        ...
        <table className="min-w-full bg-white rounded-lg border border-gray-300 dark:bg-gray-700 dark:border-gray-600">
          <thead>
            <tr className="bg-gray-200 dark:bg-gray-600">
              <th className="px-4 py-2 dark:bg-gray-700 text-center text-gray-600 dark:text-gray-300 text-sm md:text-base">
                Month
              </th>
              <th className="px-4 py-2 text-center dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-sm md:text-base">
                Total Credit (₹)
              </th>
              <th className="px-4 py-2 text-center dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-sm md:text-base">
                Closing Balance (₹)
          ...
          <tbody>
            {Object.keys(monthSummary).length > 0 ? (
              Object.keys(monthSummary).map((month) => (
                ...
                >
                  <td className="px-4 py-2 text-gray-700 dark:bg-gray-700 dark:text-gray-300 text-sm md:text-base">
                    <div className="flex items-center justify-center dark:bg-gray-700 ">
                      {month}
                    </div>
                  </td>
                  <td className="px-4 py-2 text-gray-700 dark:text-gray-300 dark:bg-gray-700 text-right text-sm md:text-base">
              ...
              <tr>
                <td
                  colSpan="3"
                  className="text-center py-4 text-gray-600 dark:bg-gray-700 dark:text-gray-300"
                >
                  No data available
                </td>
              </tr>
...
export default PayMasterPriview;
